...
function get20s(array){
  ...
  for (let i = 0; i < array.length; i++){
    if(
      array[i].years.split(" - ") > "1900" &&
      array[i].years.split(" - ") < "2000"
    ){
...
function addArtist(array, object){
  ...
  let object ={
  id: 20,
  name: "Samantha Prewitt", 
  years: "March 7, 1982 - current day",
  genre: "Web Design",
  nationality: "Mixed",
  bio: "I'm here and trying", 
  
};
addArtist(artists, object);
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 7: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
function lotsOfArt(array){
 ...
 for (i = 0; i < array.length; i++){
   if(array[i].paintings > 100){
     return hundred.push(array[i].name);
   }
 }
lotsOfArt(artists);
}
